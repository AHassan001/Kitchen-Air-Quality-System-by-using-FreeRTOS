...
C_SRCS += \
../ThirdPart/SEGGER/Config/SEGGER_SYSVIEW_Config_FreeRTOS.c 

OBJS += \
./ThirdPart/SEGGER/Config/SEGGER_SYSVIEW_Config_FreeRTOS.o 

C_DEPS += \
./ThirdPart/SEGGER/Config/SEGGER_SYSVIEW_Config_FreeRTOS.d 


# Each subdirectory must supply rules for building sources it contributes
ThirdPart/SEGGER/Config/%.o: ../ThirdPart/SEGGER/Config/%.c ThirdPart/SEGGER/Config/subdir.mk
	@echo 'Building file: $<'
