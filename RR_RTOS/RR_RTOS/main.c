 ...
 * File Name: main.c
 *
 * Description: source file for Temperature checker by using FreeRTOS Round Robin Scheduling algorithm
 *
...
#define LCD_Priority 		 2  /* All Have the same priority */
#define MOTOR_LED_Priority	 2  /* All Have the same priority */
#define TEMP_Priority		 2  /* All Have the same priority */
#define Gas_Priority		 2	/* All Have the same priority */
...
TaskHandle_t Temp_Sensor_Handeler, Gas_Sensor_Handler,Dc_motor_Handler, Lcd_Handler;
 ...
 * 1st Run Data:
 *
 * Program:   9994 bytes (30.5% Full)
 * (.text + .data + .bootloader)
 *
 * Data:       1817 bytes (88.7% Full)
 * (.data + .bss + .noinit)
 *
 *  Build Finished. 0 errors, 9 warnings. (took 2s.168ms)
 *
 * */
